...
export function getConfig() {
	return {
		TYPE: process.env.INPUT_TYPE?.toLowerCase() || "",
		FILE: process.env.INPUT_FILE || "",
		STYLE: process.env.INPUT_STYLE?.toLowerCase() || "",
		COUNT: process.env.INPUT_COUNT || "5",
		BLOG_URL: process.env.INPUT_BLOG_URL?.toLowerCase() || "",
